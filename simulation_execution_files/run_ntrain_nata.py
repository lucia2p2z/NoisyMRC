from base_simulations_ntrain import simulation_ntrain_natarajan
...
summary_data, summary_results, results_models = simulation_ntrain_natarajan(X=X, Y=Y,
                                                                            nvector=nvector,
                                                                            nrep=Nrep,
                                                                            rho1=rho1,
                                                                            rho2=rho2)
print('simulation NATARAJAN done!')
