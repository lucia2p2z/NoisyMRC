from base_simulations_perfeval import simulation_perfeval_mrc
...
summary_data, summary_results, results_models = simulation_perfeval_mrc(X=X, Y=Y,
                                                                        nvector=nvector,
                                                                        nrep=Nrep,
                                                                        det=det,
                                                                        lambda0=lambda0,
                                                                        rho1=rho1,
                                                                        rho2=rho2)
print('simulation perfeval MRC done!')
