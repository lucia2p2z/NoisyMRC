from base_simulations_ntrain import simulation_ntrain_cleanlab
...
if __name__ == '__main__':
    ...
    summary_data, summary_results, results_models = simulation_ntrain_cleanlab(X=X, Y=Y,
                                                                               nvector=nvector,
                                                                               nrep=Nrep,
                                                                               rho1=rho1,
                                                                               rho2=rho2)
    print('simulation CLEANLEARNING done!')
    ...
    filename1 = 'CL_' + dataName + '_summary_data'
    save_dataframe(
        df=summary_data,
        df_name=filename1,
        save_dir=main_dir
    ...
    filename2 = 'CL_' + dataName + '_summary_results'
    save_dataframe(
        df=summary_results,
        df_name=filename2,
        save_dir=main_dir
